...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="/img/ITBfavicon.png">
</head>
<body class="bg-gray-900 flex flex-col items-center justify-center min-h-screen p-6">
    ...
    <!-- Títol -->
    <h1 class="text-2xl font-bold text-blue-700 mb-4 items-center justify-center">BLOC 01</h1>
    <h1 class="text-2xl font-bold text-blue-700 mb-4 items-center justify-center">Demos A01 i A02</h1>
    ...
    <!-- Títol -->
    <h1 class="text-2xl font-bold text-blue-700 mb-4 items-center justify-center">Demos A04 i A05</h1>
    
    <!-- Grid de botons -->
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 w-full max-w-2xl">
        <!-- Botons -->
        <a href="demo02/demo01.html" class="bg-blue-600 text-white py-3 px-5 rounded-lg shadow-md text-center hover:bg-blue-700">Demo 01</a>
        <a href="demo02/demo02.html" class="bg-blue-600 text-white py-3 px-5 rounded-lg shadow-md text-center hover:bg-blue-700">Demo 02</a>
        <a href="demo02/demo03.php" class="bg-blue-600 text-white py-3 px-5 rounded-lg shadow-md text-center hover:bg-blue-700">Demo 03</a>
        <a href="demo02/demo04.php" class="bg-blue-600 text-white py-3 px-5 rounded-lg shadow-md text-center hover:bg-blue-700">Demo 04</a>
        <a href="demo02/demo05.php" class="bg-blue-600 text-white py-3 px-5 rounded-lg shadow-md text-center hover:bg-blue-700">Demo 05</a>
<!--        <a href="demo01/demo06.php" class="bg-blue-600 text-white py-3 px-5 rounded-lg shadow-md text-center hover:bg-blue-700">Demo 06</a>-->
    </div>
